...
from cnsproject.network.connections import Connection, fullyConnect
...
pn2 = LIFPopulation(
        ...
        is_inhibitory = True, learning = False, R = 1, C = 20, threshold = -40
    )
pn2.dt = dt

con1 = Connection(
        pre = pn1, post = pn2, lr = None, weight_decay = 0.0,
        J = 2, tau_s = 10, trace_scale = 1., dt = dt, connectivity= fullyConnect
    )
